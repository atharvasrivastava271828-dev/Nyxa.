...
const staticIndianMvpTasks = [
  {
    ...
    title: "School Marks Percentage & Grade Calculator",
    description: "Calculate exact percentage, division, and grade points for Class 9-12 with Best-of-5 support.",
    price: 0,
    class: "Education",
  ...
  },
  {
    id: "homework-tracker",
    provider_id: "00000000-0000-0000-0000-000000000000",
    title: "Homework & Assignment Tracker with Exam Countdown",
  ...
  },
  {
    ...
    description: "Split rent, bills, and trip expenses for roommates and groups with auto-calculated net balances and WhatsApp export.",
    price: 0,
    class: "Business",
    kind: "Expense Splitter",
    dubs: ["expenses", "splitwise", "roommates", "trip", "bills"],
  ...
  },
  {
    id: "tds-estimator",
    provider_id: "00000000-0000-0000-0000-000000000000",
    title: "Quick Salary & TDS Estimator (New vs Old Tax Regime)",
    description: "Compare your monthly take-home salary and tax liability under New vs Old Tax Regimes.",
    price: 0,
    class: "Business",
    kind: "TDS Estimator",
  ...
  },
  {
    ...
    description: "Generate compliant tax invoices with automatic CGST/SGST/IGST breakdown, HSN/SAC codes, and print view.",
    price: 0,
    class: "Business",
    kind: "GST Invoice",
  ...
  },
  {
    ...
    provider_id: "00000000-0000-0000-0000-000000000000",
    title: "Salary & CTC Restructuring Calculator",
    description: "Evaluate the impact of the 50% basic pay rule on your PF, gratuity, and net monthly take-home.",
    price: 0,
    class: "Business",
  ...
  },
  {
    id: "sarkari-resume",
    provider_id: "00000000-0000-0000-0000-000000000000",
    title: "Biodata & Official Resume Formatter",
    description: "Format your education and experience into standard official job application biodata (UPSC, SSC, Railways).",
    price: 0,
    class: "Education",
    kind: "Biodata Formatter",
    dubs: ["resume", "biodata", "upsc", "ssc", "job"],
  ...
  },
  {
    ...
    provider_id: "00000000-0000-0000-0000-000000000000",
    title: "Document Format & Checksum Validator (PAN, Aadhaar, IFSC, Pincode)",
    description: "Verify structural checksums and decode metadata for PAN, Aadhaar, IFSC branch codes, and postal pincodes.",
    price: 0,
    class: "Tech",
