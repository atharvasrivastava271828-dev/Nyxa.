...
export const POPULAR_HSN_CODES = [
  { code: '998314', desc: 'IT Design & Development Services', rate: 18, type: 'services' },
  { code: '998313', desc: 'IT Infrastructure & Support Services', rate: 18, type: 'services' },
  { code: '998311', desc: 'Management & Business Consulting Services', rate: 18, type: 'services' },
  { code: '998413', desc: 'Web Hosting & Cloud Data Services', rate: 18, type: 'services' },
  { code: '998361', desc: 'Advertising & Marketing Services', rate: 18, type: 'services' },
  { code: '8471', desc: 'Automatic Data Processing / Computers & Peripherals', rate: 18, type: 'goods' },
  { code: '8517', desc: 'Telecommunication Apparatus & Smartphones', rate: 18, type: 'goods' },
  { code: '8504', desc: 'Electrical Power Adaptors & Chargers', rate: 18, type: 'goods' },
  { code: '9965', desc: 'Goods Transport Agency (GTA) Services', rate: 5, type: 'services' },
  { code: '998211', desc: 'Legal Consultancy & Advisory Services', rate: 18, type: 'services' },
  { code: '998222', desc: 'Accounting, Auditing & Tax Services', rate: 18, type: 'services' },
  { code: '4820', desc: 'Registers, Notebooks & Paper Stationery', rate: 12, type: 'goods' },
  { code: '6109', desc: 'T-Shirts, Apparel & Garments', rate: 5, type: 'goods' },
  { code: '996331', desc: 'Catering & Food Provision Services', rate: 5, type: 'services' },
];
...
const SAMPLE_HARDWARE_INTRA: typeof SAMPLE_TECH_B2B = {
  supplier: {
...
export default function GstInvoice() {
  ...
  // Auto-detect supplier state when supplier GSTIN changes
  ...
  // Auto-detect buyer state and Place of Supply when buyer GSTIN changes
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] font-sans pb-24">
      ...
      <header className="no-print bg-[var(--card-bg)] border-b border-[var(--border)] sticky top-0 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight leading-none">Indian GST Invoice Generator</h1>
              <p className="text-xs text-[var(--muted)] mt-0.5">
                Compliant GST Tax Invoices with Place of Supply & HSN Summary
              </p>
            </div>
          </div>
            ...
            <div className="bg-[var(--secondary-bg)] p-1 rounded-xl border border-[var(--border)] flex items-center gap-1 text-xs font-semibold">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-all flex items-center gap-1.5 ${
                  activeTab === 'edit'
                    ? 'bg-[var(--card-bg)] shadow text-[var(--foreground)]'
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="space-y-6">
              ...
              <div className="nyxa-card gap-4">
                <div className="flex items-center justify-between border-b pb-2">
                  <h2 className="text-sm font-bold uppercase tracking-wider text-[var(--muted)] m-0 flex items-center gap-2">
                    ...
                    2. Supplier Details (Billed From)
                  </h2>
                ...
                {supplier.logoUrl && (
                  <div className="flex items-center gap-3 p-2 bg-[var(--secondary-bg)] rounded-xl border border-[var(--border)]">
                    {/* eslint-disable-next-html-next-image-img */}
                    <img src={supplier.logoUrl} alt="Supplier Logo" className="h-10 object-contain max-w-[120px]" />
                    <button
              ...
              <div className="nyxa-card bg-[var(--secondary-bg)]/60 justify-between gap-4">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  {isIntraState ? (
                    <>
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-medium">{formatCurrency(totals.aggregateCgst)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[var(--muted)]">Total SGST Amount:</span>
                        <span className="font-mono font-medium">{formatCurrency(totals.aggregateSgst)}</span>
                      </div>
                    </>
                  ) : (
                    <div className="flex justify-between">
                      <span className="text-[var(--muted)]">Total IGST Amount:</span>
                      <span className="font-mono font-medium">{formatCurrency(totals.aggregateIgst)}</span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between items-center text-base font-bold">
                    ...
                    <span className="font-mono text-lg text-blue-600">{formatCurrency(totals.grandTotal)}</span>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="nyxa-card gap-4">
                ...
                {signatureUrl && (
                  <div className="p-2 border rounded-xl bg-white w-36">
                    {/* eslint-disable-next-html-next-image-img */}
        ...
        {/* ========================================== */}
        {/* TAB 2: PRINT PREVIEW / INVOICE DOCUMENT    */}
        {/* ========================================== */}
        {(activeTab === 'preview' || true) && (
          <div className={`print-area ${activeTab !== 'preview' ? 'hidden no-print' : 'block'}`}>
            <div className="max-w-[210mm] mx-auto bg-white text-slate-900 shadow-2xl rounded-2xl border border-slate-200 p-8 sm:p-10 font-sans text-xs space-y-6">
              ...
              <div className="flex flex-wrap justify-between items-start border-b border-slate-300 pb-6 gap-4">
                <div className="space-y-1 max-w-md">
                  {supplier.logoUrl && (
                    // eslint-disable-next-html-next-image-img
                    <img src={supplier.logoUrl} alt="Logo" className="h-12 object-contain mb-3" />
                  )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 border-b border-slate-200 pb-6 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-700 font-mono mt-1">
                    <strong>GSTIN:</strong> {buyer.gstin || 'URP (Unregistered Persons)'}
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  {metadata.eWayBillNo && (
                    <p className="text-slate-700 font-mono text-[11px] pt-1">
                      <strong>E-Way Bill:</strong> {metadata.eWayBillNo}
                    </p>
                  )}
                </div>
              </div>
                  ...
                  <tbody className="divide-y divide-slate-200 border-b border-slate-300">
                    {calculatedItems.map((item, idx) => (
                      <tr key={item.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}>
                        ...
                        <td className="p-2.5 text-right font-mono font-medium">{item.taxableValue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                        <td className="p-2.5 text-center font-mono">{item.gstRate}%</td>
                        <td className="p-2.5 text-right font-mono text-slate-600">{item.totalTax.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                        <td className="p-2.5 text-right font-mono font-bold text-slate-900">{item.totalAmount.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              {/* HSN / SAC TAX SUMMARY TABLE (COMPLIANCE MANDATORY) */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start pt-2">
                ...
                <div className="space-y-2 text-xs font-medium border border-slate-200 p-4 rounded-xl bg-slate-50/50">
                  ...
                  <div className="flex justify-between items-center text-sm font-bold text-slate-900">
                    <span>Grand Total:</span>
                    <span className="font-mono text-base text-slate-900">{formatCurrency(totals.grandTotal)}</span>
                  </div>
                </div>
              </div>
