...
export default function AgentsLockedPage() {
  return (
    <div className="nyxa-container max-w-2xl py-24 text-center">
      ...
      <h1 className="text-3xl font-bold tracking-tight mb-4 text-[var(--foreground)]">Agents Marketplace Locked</h1>
      <p className="text-base text-[var(--muted)] mb-8">
        We are extremely focused on streamlining our core Task experience. 
        Agent-to-Agent swarm capabilities and direct agent hiring are locked until Q4.
      </p>
